...
Generated by ResultVista.
        ...
        return render_template(
            url_for("student_detail", enrollment_no=enrollment_no),
        )
...
def generate_student_pdf(student, subjects, max_marks):
    ...
    p.drawString(100, height - 100, f"Academic Results - {student['name'].upper()}")
    ...
    p.drawString(250, y_position, f"Marks (Max: {max_marks})")
    y_position -= 20
